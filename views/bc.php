...
$pagebuilder->addresource('cssfiles', '/CSS/Base/CSS/FetchCSS?path=page___3e5ab4bbf9650c1b6f9158646ebc2b79_m.css');
...
$pagebuilder->addresource('jsfiles', '/js/6ce8a94bc4cb098fb9a978355f8234b3.js');
$pagebuilder->set_page_name("Upgrade");
...
<p style="text-align: center;">NOTICE: This page is for decoration, you cannot purchase anything on this page.</p>
			...
			<thead class="product-title">
				<tr>
					<td class="center-bold">
						...
						<img data-attribute="free" src="/images/77add140640c3388e6c9603bc5983846.png" alt="free" />
					</td>
					<td class="center-bold">
						<h2 class="product-space">Classic</h2>
                        <img data-attribute="classic" src="/images/ba707f47bb20a1f4804da461fb5d3c31.png" alt=" bc" />
					</td>
					<td class="center-bold">
						<h2 class="product-space">Turbo</h2>
                        <img data-attribute="turbo" src="/images/d7eb3ed186e351d99ce8c11503675721.png" alt="tbc" />
					</td>
					<td class="center-bold">
						<h2 class="product-space">Outrageous</h2>
                        <img data-attribute="outrageous" src="/images/ca1d0aef06c5fc06a2d8b23aea5e20d2.png" alt="obc" />
					</td>
				</tr>
			</thead>
...
<div id="RightColumnWrapper">
    ...
    <div class="cell cellDivider">
        ...
        <div class="cell cellDivider">
            <h3>Gift Cards</h3><br />
            <a href="/gamecard" class="giftCardImage"><img src="/images/bf9f4b65f937ad01f07ae6714eaba723.png" alt="giftcard" /></a>
            <div>
    ...
    <div class="cell cellDivider">
        <h3>Game Cards</h3>
        <a href="/gamecards"><img alt="ROBLOX Gamecards" src="/images/863c65342816d665de28411cf47cde42.png" /></a>
    ...
    <div class="cell">
        <h3>Parents</h3>
        <p>Learn more about Builders Club and how we help <a href="/parents" class="roblox-interstitial">keep kids safe.</a></p>
        <h3>Cancellation</h3>
...
<div id="Footer" class="footer-container">
    <div class="FooterNav">
        ...
        &nbsp;|&nbsp;
        <a href="/advertise-on-roblox" class="roblox-interstitial">Advertise with Us</a>
        &nbsp;|&nbsp;
        <a href="/press" class="roblox-interstitial">Press</a>
        &nbsp;|&nbsp;
        <a href="/contact-us" class="roblox-interstitial">Contact Us</a>
        &nbsp;|&nbsp;
            <a href="/about" class="roblox-interstitial">About Us</a>
&nbsp;|&nbsp;        <a href="http://blog.roblox.com">Blog</a>
        &nbsp;|&nbsp;
            <a href="/careers" class="roblox-interstitial">Jobs</a>
&nbsp;|&nbsp;        <a href="/parents" class="roblox-interstitial">Parents</a>
    </div>
    <div class="legal">
            <div class="left">
    ...
    <a href="//privacy.truste.com/privacy-seal/Roblox-Corporation/validation?rid=2428aa2a-f278-4b6d-9095-98c4a2954215" title="TRUSTe Children privacy certification" target="_blank">
        <img style="border: none" src="/images/seal.png" width="133" height="45" alt="TRUSTe Children privacy certification"/>
            ...
            <div class="right">
                <p class="Legalese">
    ROBLOX, "Online Building Toy", characters, logos, names, and all related indicia are trademarks of <a href="/" ref="footer-smallabout" class="roblox-interstitial">ROBLOX Corporation</a>, ©2015. Patents pending.
    ...
    <div style="min-height: 275px; background-color: white;">
        ...
        <div class="RevisedFooter">
            <div style="width:200px;margin:10px auto 0 auto;">
                <a href="/?returnUrl=https%3A%2F%2Fwww.roblox.com%2Fpremium%2Fmembership"><div class="RevisedCharacterSelectSignup"></div></a>
                <a class="HaveAccount" href="/newlogin?returnUrl=https%3A%2F%2Fwww.roblox.com%2Fpremium%2Fmembership">I have an account</a>
            </div>
        </div>
    </div>
</div>
