...
<link rel='stylesheet' href='/CSS/Base/CSS/FetchCSS?path=page___1ae67ab335cc4c2836e97fc51443b18d.css' />
            ...
            <div id="header-login-wrapper" class="iframe-login-signup" data-display-opened="">
                ...
                <span class="studioiFrameLogin">
                    ...
                    <div id="iFrameLogin" class="studioiFrameLogin" style="display: none">
                        <iframe class="login-frame" src="/Login/iFrameLogin.aspx?loginRedirect=True&amp;parentUrl=http%3a%2f%2fwww.roblox.com%2fide%2fwelcome" scrolling="no" frameborder="0"></iframe>
                    </div>
                </span>
            </div>
        <!-- This is only after the login stuff because IE7 demands floated elements be before non-floated -->
        <img src="/images/63c8081b4b083e1b75685aef06cdfa77.png" alt="Roblox Studio Title" />
        <p id="HomeLink">
...
<h2 id="StudioGameTemplates">GAME TEMPLATES</h2>
            ...
            <button onclick="RobloxLaunch.StartGame('/Game/edit.ashx?PlaceID=' + play_placeId + '&upload=' + play_placeId, 'edit.ashx', '/Login/Negotiate.ashx', 'FETCH', true);">Button</button>
            
                <div class="templates" data-templatetype="Basic">
                        <div class="template" placeid="95206881">
                            <a href="javascript:RobloxLaunch.StartGame('/Game/edit.ashx?PlaceID=' + play_placeId + '&upload=' + play_placeId, 'edit.ashx', '/Login/Negotiate.ashx', 'FETCH', true);" class="game-image" ><img  class='' src='https://t6.rbxcdn.com/17507896d5a29371ea8048fbdc3b1d74' /></a>
                            <p>Baseplate</p>
                        </div>
                ...
                <div class="templates" data-templatetype="Theme">
                        <div class="template" placeid="203783329">
                            <a href="" class="game-image" ><img  class='' src='https://t0.rbxcdn.com/b5681e74280c69e8111bcde693116de8' /></a>
                            <p>City</p>
                        </div>
                        <div class="template" placeid="203810088">
                            <a href="" class="game-image" ><img  class='' src='https://t5.rbxcdn.com/1c6158e9e1b9d8cbc097c9f034a27934' /></a>
                            <p>Medieval</p>
                        </div>
                ...
                <div class="templates" data-templatetype="Gameplay">
                        <div class="template" placeid="203812057">
                            <a href="" class="game-image" ><img  class='' src='https://t6.rbxcdn.com/684cafae0c216e9266718a2f615c91ed' /></a>
                            <p>Obby</p>
                        </div>
                        <div class="template" placeid="215383192">
                            <a href="" class="game-image" ><img  class='' src='https://t1.rbxcdn.com/3608253a087bddcdc234cca8060a4624' /></a>
                            <p>Racing</p>
                        </div>
                        <div class="template" placeid="203885589">
                            <a href="" class="game-image" ><img  class='' src='https://t2.rbxcdn.com/a0804859cfd32ee56a35a9d68bc426d7' /></a>
                            <p>Shooter</p>
                        </div>
